  ...
  return (
    <>
      ...
      <div className="print-container bg-white">
        ...
        <div className="avoid-break mb-8">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="text-right">
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">SALES QUOTE</h1>
        ...
        <div className="avoid-break grid grid-cols-3 gap-6 mb-8">
          {/* From */}
          <div>
            ...
            <div className="space-y-1">
              ...
              {quote.sellersBuyerContact?.__typename === "PersonContact" &&
                quote.sellersBuyerContact.business?.name && (
                  <p className="text-sm text-gray-600">{quote.sellersBuyerContact.business.name}</p>
                )}
              {quote.sellersBuyerContact?.__typename === "BusinessContact" &&
                quote.sellersBuyerContact.address && (
                  <p className="text-sm text-gray-600">{quote.sellersBuyerContact.address}</p>
                )}
              {quote.sellersBuyerContact?.__typename === "PersonContact" &&
                quote.sellersBuyerContact.email && (
                  <p className="text-sm text-gray-600">{quote.sellersBuyerContact.email}</p>
                )}
              {quote.sellersBuyerContact?.phone && (
                <p className="text-sm text-gray-600">{quote.sellersBuyerContact.phone}</p>
              )}
            </div>
          </div>
        ...
        {rentalItems.length > 0 && (
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Rental Items</h2>
