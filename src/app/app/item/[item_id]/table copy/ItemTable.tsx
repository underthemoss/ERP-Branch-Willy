...
import { useItemNew } from "../ItemProviderNew";

export const ItemTableNew = () => {
  const { item, loadMore, rows } = useItemNew();
                    ...
                    >
                      {column.column_type && (
                        <CellRender
                          ...
                          onBlur={async (value) => {
                            await updateCell(row.id, column.column_id, value);
                          }}
                        ></CellRender>
                      )}
                    </Box>
