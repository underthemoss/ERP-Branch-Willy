...
import { PoLineItemStatus } from "@/graphql/graphql";
import {
...
const CreateSalePurchaseOrderLineItemConfirmationStep: React.FC<Props> = ({
  lineItemId,
  Footer,
}) => {
  const { data, loading } = useGetPurchaseOrderSaleLineItemByIdCreateDialogQuery({
    ...
    <Box>
      <Box sx={{ p: 3 }}>
        <Typography variant="h6" gutterBottom>
          Confirm Sale Purchase Order Line Item
        </Typography>
        {loading ? (
            ...
            <Box>
              ...
              <Box sx={{ pl: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  <strong>Quantity:</strong> {lineItem.po_quantity ?? "N/A"}
                </Typography>
              </Box>
            </Box>
              ...
              <Box sx={{ pl: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  ...
                  {formatCurrency(
                    lineItem.price?.__typename === "SalePrice" &&
                      lineItem.price.unitCostInCents &&
                      lineItem.po_quantity
                      ? lineItem.price.unitCostInCents * lineItem.po_quantity
                      : null,
                  )}
                </Typography>
              </Box>
