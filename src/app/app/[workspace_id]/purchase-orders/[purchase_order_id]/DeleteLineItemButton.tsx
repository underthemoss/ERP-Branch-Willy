...
import { useSoftDeletePurchaseOrderLineItemMutation } from "@/graphql/hooks";
...
// GQL mutation for soft deleting a purchase order line item
graphql(`
  mutation SoftDeletePurchaseOrderLineItem($id: String) {
    softDeletePurchaseOrderLineItem(id: $id) {
...
export const DeleteLineItemButton: React.FC<DeleteLineItemButtonProps> = ({
  ...
  const [softDelete, { loading }] = useSoftDeletePurchaseOrderLineItemMutation();
