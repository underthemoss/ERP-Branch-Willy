...
const CreateRentalPurchaseOrderLineItemPricingSelectionStep: React.FC<
  PricingSelectionStepProps
> = ({ lineItemId, Footer, pimCategoryId }) => {
  ...
  useEffect(() => {
    if (data?.getPurchaseOrderLineItemById?.__typename === "RentalPurchaseOrderLineItem") {
...
export default CreateRentalPurchaseOrderLineItemPricingSelectionStep;
