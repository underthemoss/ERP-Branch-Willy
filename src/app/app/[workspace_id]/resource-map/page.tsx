...
import { Building2, GitBranch, List, MapPin, Plus, Search, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          {activeTab === "LOCATION" && (
            <LocationsTab workspaceId={workspace_id} viewMode={viewMode} searchTerm={searchTerm} />
          )}
