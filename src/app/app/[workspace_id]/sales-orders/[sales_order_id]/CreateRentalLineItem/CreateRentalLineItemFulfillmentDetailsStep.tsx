...
const CreateRentalLineItemFulfillmentDetailsStep: React.FC<FulfillmentDetailsStepProps> = ({
  ...
  const handleContinue = async () => {
    try {
      // Use enum value for delivery_method if available
      // @ts-ignore: DeliveryMethod enum may be generated by codegen
      const deliveryMethodEnum = fulfillmentMethod.toUpperCase();
      await updateLineItem({
        variables: {
          input: {
            ...
            delivery_charge_in_cents: Math.round(parseFloat(deliveryCharge || "0") * 100),
