...
export function CreatePurchaseOrderDialog({
  ...
  const { data: pricesData, loading: pricesLoading } = useListPricesQuery({
    ...
    skip: activeStep < 1, // Keep prices loaded from step 1 onwards (including confirmation step)
  });
  ...
  const handleNext = () => {
    ...
    if (activeStep === 1 && !selectedPriceId) {
  ...
  const handleSubmit = async (shouldSubmit: boolean) => {
    ...
    try {
      // Step 1: Create Purchase Order (PO number will be auto-generated by backend)
  ...
  const steps = ["Vendor & Project", "Select Price", "Confirm"];
